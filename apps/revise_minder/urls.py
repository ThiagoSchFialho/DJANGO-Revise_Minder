...
from apps.revise_minder.views import index, revisions_home, past_revisions, subject, delete_subject, edit_subject, add_study, my_studies, delete_study, edit_study
